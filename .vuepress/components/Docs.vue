                            ...
                            <b-card no-body
                                ...
                                <b-list-group flush>
                                    <b-list-group-item class="py-4">
                                        <b-link :href="`https://github.com/tokeniac/bep20-generator/blob/v${token.version}/dist/${contracts.token.contractName}.dist.sol`"
                                                target="_blank">
                                            <b-img :src="`https://img.shields.io/badge/version-${token.version}-blue`"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/tokeniac/bep20-generator/actions" target="_blank">
                                            <b-img src="https://github.com/tokeniac/bep20-generator/workflows/CI/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://coveralls.io/github/tokeniac/bep20-generator?branch=master" target="_blank">
                                            <b-img src="https://coveralls.io/repos/github/tokeniac/bep20-generator/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/tokeniac/bep20-generator/blob/master/LICENSE" target="_blank">
                                            <b-img src="https://img.shields.io/github/license/tokeniac/bep20-generator.svg"></b-img>
                                        </b-link>
                                    </b-list-group-item>
                                    <b-list-group-item class="py-4">
  ...
  export default {
    ...
    computed: {
      controlFlow: function () {
        return `https://github.com/tokeniac/bep20-generator/blob/v${this.token.version}/analysis/control-flow/${this.contracts.token.contractName}.png`;
      },
      inheritanceTree: function () {
        return `https://github.com/tokeniac/bep20-generator/blob/v${this.token.version}/analysis/inheritance-tree/${this.contracts.token.contractName}.png`;
      },
      uml: function () {
        return `https://github.com/tokeniac/bep20-generator/blob/v${this.token.version}/analysis/uml/${this.contracts.token.contractName}.svg`;
      },
    },
    mounted () {
      this.initDapp();
